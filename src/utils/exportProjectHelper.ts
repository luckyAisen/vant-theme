 ...
 * @returns
 */
export const exportProjectHelper = (project: Project) => {
  ...
  zip.file(
    `${WorkspaceEnum.WORKSPACE_DOWNLOAD_INFO}`,
    JSON.stringify({
      ...project,
      cssVar
    })
  ...
  if (version === ProjectEnum.VERSION_4) {
...
*/`;
  ...
  if (version === ProjectEnum.VERSION_3) {
...
*/`;
  ...
  if (version === ProjectEnum.VERSION_2) {
    const config = cssVar.light;
