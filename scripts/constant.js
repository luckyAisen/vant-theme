...
export const VERSION_LIST = ["v2", "v3"];
export const VANT_PUBLIC_PATH = "public/vant";
export const VANT_MOBILE_LOCAL_PREFIX = "src";
export const VANT_MOBILE_PAGE_V2_PATH = `${VANT_MOBILE_LOCAL_PREFIX}/mobile-v2/index.html`;
export const VANT_MOBILE_PAGE_V3_PATH = `${VANT_MOBILE_LOCAL_PREFIX}/mobile-v3/index.html`;
export const VANT_MOBILE_PAGE_CONCAT_PATH = (v) =>
  `${VANT_MOBILE_LOCAL_PREFIX}/mobile-${v}/index.html`;
export const VANT_MENU_CONCAT_JSON = (v) => `src/json/menus-${v}.json`;
export const VANT_STYLES_CONCAT_JSON = (v) => `src/json/styles-${v}.json`;
