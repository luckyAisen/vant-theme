(function () {
    ...
    groupList.map((item) => {
      ...
      item.children.map(route => {
        ...
        const obj = {
          ...
          name,
          component: `'()=> import(
          /* webpackChunkName: "component-${path}" */ "../views/component/vant/${tuoTo_(name)}/demo/index.vue"
        )'`,
        };
        array.push(obj);
      })
  ...
  function consoleData() {
    setTimeout(() => {
      ...
      console.log("routerList，路由表：", routerList)
    }, 1000 * 120)
  }
  function tuoTo_(target) {
