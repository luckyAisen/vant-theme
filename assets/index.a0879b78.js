...
`,[v("absolute-positioned",`
 ...
 right: 0;
 height: 2px;
`,[Ke({enterDuration:"0.3s",leaveDuration:"0.8s"}),m("loading-bar",`
 width: 100%;
 transition:
 max-width 4s linear,
 ...
 max-width .2s linear,
 background .2s linear;
 `)])]),ne=globalThis&&globalThis.__awaiter||function(o,e,n,i){function l(r){return r instanceof n?r:new n(function(d){d(r)})}return new(n||(n=Promise))(function(r,d){function a(t){try{c(i.next(t))}catch(u){d(u)}}function s(t){try{c(i.throw(t))}catch(u){d(u)}}function c(t){t.done?r(t.value):l(t.value).then(a,s)}c((i=i.apply(o,e||[])).next())})};function U(o,e){return`${e}-loading-bar ${e}-loading-bar--${o}`}var Ao=w({name:"LoadingBar",setup(o){const{inlineThemeDisabled:e}=T(),{props:n,mergedClsPrefixRef:i}=G(Le),l=k(null),r=k(!1),d=k(!1),a=k(!1),s=k(!1);let c=!1;const t=k(!1),u=P(()=>{const{loadingBarStyle:g}=n;return g?g[t.value?"error":"loading"]:""});function h(){return ne(this,void 0,void 0,function*(){r.value=!1,a.value=!1,c=!1,t.value=!1,s.value=!0,yield W(),s.value=!1})}function p(g=0,B=80,E="starting"){return ne(this,void 0,void 0,function*(){yield h(),a.value=!0,d.value=!0,yield W();const O=l.value;!O||(O.style.maxWidth=`${g}%`,O.style.transition="none",O.offsetWidth,O.className=U(E,i.value),O.style.transition="",O.style.maxWidth=`${B}%`)})}function L(){if(c||t.value||!a.value)return;c=!0;const g=l.value;!g||(g.className=U("finishing",i.value),g.style.maxWidth="100%",g.offsetWidth,a.value=!1)}function z(){if(!(c||t.value))if(!a.value)p(100,100,"error").then(()=>{t.value=!0;const g=l.value;!g||(g.className=U("error",i.value),g.offsetWidth,a.value=!1)});else{t.value=!0;const g=l.value;if(!g)return;g.className=U("error",i.value),g.style.maxWidth="100%",g.offsetWidth,a.value=!1}}function $(){r.value=!0}function R(){r.value=!1}function A(){return ne(this,void 0,void 0,function*(){yield h()})}const _=N("LoadingBar","-loading-bar",Ro,xo,n,i),F=P(()=>{const{self:{height:g,colorError:B,colorLoading:E}}=_.value;return{"--n-height":g,"--n-color-loading":E,"--n-color-error":B}}),S=e?J("loading-bar",void 0,F,n):void 0;return{mergedClsPrefix:i,loadingBarRef:l,started:d,loading:a,entering:r,transitionDisabled:s,start:p,error:z,finish:L,handleEnter:$,handleAfterEnter:R,handleAfterLeave:A,mergedLoadingBarStyle:u,cssVars:e?void 0:F,themeClass:S==null?void 0:S.themeClass,onRender:S==null?void 0:S.onRender}},render(){if(!this.started)return null;const{mergedClsPrefix:o}=this;return f(ue,{name:"fade-in-transition",appear:!0,onEnter:this.handleEnter,onAfterEnter:this.handleAfterEnter,onAfterLeave:this.handleAfterLeave,css:!this.transitionDisabled},{default:()=>{var e;return(e=this.onRender)===null||e===void 0||e.call(this),_e(f("div",{class:[`${o}-loading-bar-container`,this.themeClass]},f("div",{ref:"loadingBarRef",class:[`${o}-loading-bar`],style:[this.cssVars,this.mergedLoadingBarStyle]})),[[Pe,this.loading||!this.loading&&this.entering]])}})}});const Io=Object.assign(Object.assign({},N.props),{to:{type:[String,Object],default:void 0},loadingBarStyle:{type:Object}});var No=w({name:"LoadingBarProvider",props:Io,setup(o){const e=De(),n=k(null),i={start(){var r;e.value?(r=n.value)===null||r===void 0||r.start():W(()=>{var d;(d=n.value)===null||d===void 0||d.start()})},error(){var r;e.value?(r=n.value)===null||r===void 0||r.error():W(()=>{var d;(d=n.value)===null||d===void 0||d.error()})},finish(){var r;e.value?(r=n.value)===null||r===void 0||r.finish():W(()=>{var d;(d=n.value)===null||d===void 0||d.finish()})}},{mergedClsPrefixRef:l}=T(o);return I($o,i),I(Le,{props:o,mergedClsPrefixRef:l}),Object.assign(i,{loadingBarRef:n})},render(){var o,e,n;return f(D,null,f(re,{to:(o=this.to)!==null&&o!==void 0?o:"body"},f(Ao,{ref:"loadingBarRef"})),(n=(e=this.$slots).default)===null||n===void 0?void 0:n.call(e))}});const Oe={icon:Function,type:{type:String,default:"info"},content:[String,Number,Function],showIcon:{type:Boolean,default:!0},closable:Boolean,keepAliveOnHover:Boolean,onClose:Function,onMouseenter:Function,onMouseleave:Function};var Bo=y([m("message-wrapper",`
 margin: var(--n-margin);
 z-index: 0;
 ...
 box-sizing: border-box;
 opacity: 1;
 `,[j("avatar",[m("icon",{color:"var(--n-icon-color)"}),m("base-icon",{color:"var(--n-icon-color)"})]),v("show-avatar",[m("notification-main",`
 margin-left: 40px;
 width: calc(100% - 40px); 
 `)]),v("closable",[m("notification-main",[y("> *:first-child",{paddingRight:"20px"})]),j("close",`
 position: absolute;
 top: 0;
 right: 0;
 margin: var(--n-close-margin);
