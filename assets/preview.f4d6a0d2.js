...
`,[R(">",[u("input",[R("&:not(:last-child)",`
 ...
 filter: blur(2px);
 content: "";
 `)])])])])]);const Ir=Object.assign(Object.assign({},G.props),{value:String,show:{type:Boolean,default:void 0},defaultShow:{type:Boolean,default:!1},defaultValue:String,modes:{type:Array,default:()=>["rgb","hex","hsl"]},placement:{type:String,default:"bottom-start"},to:at.propTo,showAlpha:{type:Boolean,default:!0},showPreview:Boolean,swatches:Array,disabled:{type:Boolean,default:void 0},actions:{type:Array,default:null},internalActions:Array,size:String,renderLabel:Function,onComplete:Function,"onUpdate:show":[Function,Array],onUpdateShow:[Function,Array],"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]});var Pr=V({name:"ColorPicker",props:Ir,setup(e,{slots:t}){const o=$(null);let r=null;const n=wo(e),{mergedSizeRef:i,mergedDisabledRef:a}=n,{localeRef:s}=Oo("global"),{mergedClsPrefixRef:p,namespaceRef:S,inlineThemeDisabled:P}=ge(e),C=G("ColorPicker","-color-picker",Rr,or,e,p);fe(ht,{themeRef:C,renderLabelRef:me(e,"renderLabel"),colorPickerSlots:t});const w=$(e.defaultShow),T=Te(me(e,"show"),w);function M(c){const{onUpdateShow:_,"onUpdate:show":U}=e;_&&q(_,c),U&&q(U,c),w.value=c}const{defaultValue:v}=e,k=$(v===void 0?rr(e.modes,e.showAlpha):v),f=Te(me(e,"value"),k),I=$([f.value]),z=$(0),N=y(()=>Me(f.value)),{modes:j}=e,h=$(Me(f.value)||j[0]||"rgb");function x(){const{modes:c}=e,{value:_}=h,U=c.findIndex(L=>L===_);~U?h.value=c[(U+1)%c.length]:h.value="rgb"}let m,d,A,D,Y,Z,J,g;const Pe=y(()=>{const{value:c}=f;if(!c)return null;switch(N.value){case"hsv":return ve(c);case"hsl":return[m,d,A,g]=Ce(c),[...Dt(m,d,A),g];case"rgb":case"hex":return[Y,Z,J,g]=ne(c),[...st(Y,Z,J),g]}}),de=y(()=>{const{value:c}=f;if(!c)return null;switch(N.value){case"rgb":case"hex":return ne(c);case"hsv":return[m,d,D,g]=ve(c),[...ae(m,d,D),g];case"hsl":return[m,d,A,g]=Ce(c),[...ct(m,d,A),g]}}),We=y(()=>{const{value:c}=f;if(!c)return null;switch(N.value){case"hsl":return Ce(c);case"hsv":return[m,d,D,g]=ve(c),[...Be(m,d,D),g];case"rgb":case"hex":return[Y,Z,J,g]=ne(c),[...dt(Y,Z,J),g]}}),Xt=y(()=>{switch(h.value){case"rgb":case"hex":return de.value;case"hsv":return Pe.value;case"hsl":return We.value}}),Ve=$(0),Ge=$(1),Ye=$([0,0]);function Zt(c,_){const{value:U}=Pe,L=Ve.value,B=U?U[3]:1;Ye.value=[c,_];const{showAlpha:F}=e;switch(h.value){case"hsv":O((F?he:it)([L,c,_,B]),"cursor");break;case"hsl":O((F?se:rt)([...Be(L,c,_),B]),"cursor");break;case"rgb":O((F?ie:nt)([...ae(L,c,_),B]),"cursor");break;case"hex":O((F?le:Ae)([...ae(L,c,_),B]),"cursor");break}}function Jt(c){Ve.value=c;const{value:_}=Pe;if(!_)return;const[,U,L,B]=_,{showAlpha:F}=e;switch(h.value){case"hsv":O((F?he:it)([c,U,L,B]),"cursor");break;case"rgb":O((F?ie:nt)([...ae(c,U,L),B]),"cursor");break;case"hex":O((F?le:Ae)([...ae(c,U,L),B]),"cursor");break;case"hsl":O((F?se:rt)([...Be(c,U,L),B]),"cursor");break}}function Qt(c){switch(h.value){case"hsv":[m,d,D]=Pe.value,O(he([m,d,D,c]),"cursor");break;case"rgb":[Y,Z,J]=de.value,O(ie([Y,Z,J,c]),"cursor");break;case"hex":[Y,Z,J]=de.value,O(le([Y,Z,J,c]),"cursor");break;case"hsl":[m,d,A]=We.value,O(se([m,d,A,c]),"cursor");break}Ge.value=c}function O(c,_){_==="cursor"?r=c:r=null;const{nTriggerFormChange:U,nTriggerFormInput:L}=n,{onUpdateValue:B,"onUpdate:value":F}=e;B&&q(B,c),F&&q(F,c),U(),L(),k.value=c}function eo(c){O(c,"input"),uo(be)}function be(c=!0){const{value:_}=f;if(_){const{nTriggerFormChange:U,nTriggerFormInput:L}=n,{onComplete:B}=e;B&&B(_);const{value:F}=I,{value:X}=z;c&&(F.splice(X+1,F.length,_),z.value=X+1),U(),L()}}function to(){const{value:c}=z;c-1<0||(O(I.value[c-1],"input"),be(!1),z.value=c-1)}function oo(){const{value:c}=z;c<0||c+1>=I.value.length||(O(I.value[c+1],"input"),be(!1),z.value=c+1)}function ro(){M(!1)}const no=y(()=>z.value>=1),io=y(()=>{const{value:c}=I;return c.length>1&&z.value<c.length-1});At(T,c=>{c||(I.value=[f.value],z.value=0)}),Se(()=>{if(!(r&&r===f.value)){const{value:c}=Pe;c&&(Ve.value=c[0],Ge.value=c[3],Ye.value=[c[1],c[2]])}r=null});const Xe=y(()=>{const{value:c}=i,{common:{cubicBezierEaseInOut:_},self:{textColor:U,color:L,panelFontSize:B,boxShadow:F,border:X,borderRadius:K,dividerColor:ce,[Oe("height",c)]:lo,[Oe("fontSize",c)]:so}}=C.value;return{"--n-bezier":_,"--n-text-color":U,"--n-color":L,"--n-panel-font-size":B,"--n-font-size":so,"--n-box-shadow":F,"--n-border":X,"--n-border-radius":K,"--n-height":lo,"--n-divider-color":ce}}),te=P?qe("color-picker",y(()=>i.value[0]),Xe,e):void 0;function ao(){var c;const{value:_}=de,{value:U}=Ve,{internalActions:L,modes:B,actions:F}=e,{value:X}=C,{value:K}=p;return l("div",{class:[`${K}-color-picker-panel`,te==null?void 0:te.themeClass.value],onDragstart:ce=>{ce.preventDefault()},style:P?void 0:Xe.value},l("div",{class:`${K}-color-picker-control`},l(mr,{clsPrefix:K,rgba:_,displayedHue:U,displayedSv:Ye.value,onUpdateSV:Zt,onComplete:be}),l("div",{class:`${K}-color-picker-preview`},l("div",{class:`${K}-color-picker-preview__sliders`},l(cr,{clsPrefix:K,hue:U,onUpdateHue:Jt,onComplete:be}),e.showAlpha?l(pr,{clsPrefix:K,rgba:_,alpha:Ge.value,onUpdateAlpha:Qt,onComplete:be}):null),e.showPreview?l(zr,{clsPrefix:K,mode:h.value,color:de.value&&Ae(de.value),onUpdateColor:ce=>O(ce,"input")}):null),l(yr,{clsPrefix:K,showAlpha:e.showAlpha,mode:h.value,modes:B,onUpdateMode:x,value:f.value,valueArr:Xt.value,onUpdateValue:eo}),((c=e.swatches)===null||c===void 0?void 0:c.length)&&l(kr,{clsPrefix:K,mode:h.value,swatches:e.swatches,onUpdateColor:ce=>O(ce,"input")})),F!=null&&F.length?l("div",{class:`${K}-color-picker-action`},F.includes("confirm")&&l(_e,{size:"small",onClick:ro,theme:X.peers.Button,themeOverrides:X.peerOverrides.Button},{default:()=>s.value.confirm})):null,t.action?l("div",{class:`${K}-color-picker-action`},{default:t.action}):L?l("div",{class:`${K}-color-picker-action`},L.includes("undo")&&l(_e,{size:"small",onClick:to,disabled:!no.value,theme:X.peers.Button,themeOverrides:X.peerOverrides.Button},{default:()=>s.value.undo}),L.includes("redo")&&l(_e,{size:"small",onClick:oo,disabled:!io.value,theme:X.peers.Button,themeOverrides:X.peerOverrides.Button},{default:()=>s.value.redo})):null)}return{mergedClsPrefix:p,namespace:S,selfRef:o,hsla:We,rgba:de,mergedShow:T,mergedDisabled:a,isMounted:So(),adjustedTo:at(e),mergedValue:f,handleTriggerClick(){M(!0)},handleClickOutside(c){var _;!((_=o.value)===null||_===void 0)&&_.contains(c.target)||M(!1)},renderPanel:ao,cssVars:P?void 0:Xe,themeClass:te==null?void 0:te.themeClass,onRender:te==null?void 0:te.onRender}},render(){const{$slots:e,mergedClsPrefix:t,onRender:o}=this;return o==null||o(),l("div",{class:[this.themeClass,`${t}-color-picker`],ref:"selfRef",style:this.cssVars},l(ko,null,{default:()=>[l(zo,null,{default:()=>l(Cr,{clsPrefix:t,value:this.mergedValue,hsla:this.hsla,disabled:this.mergedDisabled,onClick:this.handleTriggerClick},{label:e.label})}),l(Ro,{placement:this.placement,show:this.mergedShow,containerClass:this.namespace,teleportDisabled:this.adjustedTo===at.tdkey,to:this.adjustedTo},{default:()=>l(_t,{name:"fade-in-scale-up-transition",appear:this.isMounted},{default:()=>this.mergedShow?co(this.renderPanel(),[[Io,this.handleClickOutside]]):null})})]}))}}),$r={padding:"8px 14px"};const Ar=e=>{const{borderRadius:t,boxShadow2:o,baseColor:r}=e;return Object.assign(Object.assign({},$r),{borderRadius:t,boxShadow:o,color:$o(r,"rgba(0, 0, 0, .85)"),textColor:r})},_r=je({name:"Tooltip",common:Ie,peers:{Popover:Po},self:Ar});var vt=_r;const Tr=je({name:"Ellipsis",common:Ie,peers:{Tooltip:vt}});var Mr=Tr;const Nr=Object.assign(Object.assign({},_o),G.props);var Ot=V({name:"Tooltip",props:Nr,__popover__:!0,setup(e){const t=G("Tooltip","-tooltip",void 0,vt,e),o=$(null);return Object.assign(Object.assign({},{syncPosition(){o.value.syncPosition()},setShow(n){o.value.setShow(n)}}),{popoverRef:o,mergedTheme:t,popoverThemeOverrides:y(()=>t.value.self)})},render(){const{mergedTheme:e,internalExtraClass:t}=this;return l(Ao,Object.assign(Object.assign({},this.$props),{theme:e.peers.Popover,themeOverrides:e.peerOverrides.Popover,builtinThemeOverrides:this.popoverThemeOverrides,internalExtraClass:t.concat("tooltip"),ref:"popoverRef"}),this.$slots)}}),Vr=u("ellipsis",{overflow:"hidden"},[De("line-clamp",`
 white-space: nowrap;
 display: inline-block;
 vertical-align: bottom;
 max-width: 100%;
...
`,[E("bordered",[b("border",`
 ...
 display: inline-flex;
 padding-bottom: 0;
 `,[u("submenu","margin: 0;"),u("menu-item","margin: 0;",[R("&::before",{backgroundColor:"#0000 !important"}),E("selected",[u("menu-item-content",{borderBottom:"2px solid var(--n-border-color-horizontal)"})])]),u("menu-item-content",`
 padding: 0 20px;
 border-bottom: 2px solid #0000;
 `,[E("child-active",`
 border-bottom: 2px solid var(--n-border-color-horizontal);
 `),De("disabled",[$t("border-bottom: 2px solid var(--n-border-color-horizontal);",null)])])]),E("collapsed",[u("menu-item",[E("selected",[R("&::before",`
 background-color: var(--n-item-color-active-collapsed) !important;
 `)])]),u("menu-item-content",[u("menu-item-content-header","opacity: 0;"),b("arrow","opacity: 0;"),b("icon","color: var(--n-item-icon-color-collapsed);")])]),u("menu-item",`
 transition: background-color .3s var(--n-bezier);
 ...
 border-radius: var(--n-border-radius);
 transition: background-color .3s var(--n-bezier);
 `),De("disabled",[R("&:active::before","background-color: var(--n-item-color-active);")]),E("selected",[R("&::before","background-color: var(--n-item-color-active);"),u("menu-item-content",[b("arrow","color: var(--n-arrow-color-active);"),b("icon","color: var(--n-item-icon-color-active);"),u("menu-item-content-header",`
 color: var(--n-item-text-color-active);
 `,[R("a","color: var(--n-item-text-color-active);"),b("extra","color: var(--n-item-text-color-active);")])])])]),u("menu-item-content",`
 box-sizing: border-box;
 line-height: 1.75;
 height: 100%;
 display: grid;
 ...
 opacity: .45;
 cursor: not-allowed;
 `),E("collapsed",[b("arrow","transform: rotate(0);")]),E("child-active",[u("menu-item-content-header",`
